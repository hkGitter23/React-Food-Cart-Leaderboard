...
//
// All Navigation links to each tab...
//



 //Physical applicables so that the back-end can pull all options to appear in the drop down.

  const navLinks = [
    { label: "Map", href: "/map" },
    //{ label: "FoodCart Page", href: "/foodcarts/Nanu's%20Hot%20Chicken" },
    ...
    { label: "Logout", href: "/login", isDanger: true },
              ...
              <div style={styles.dropdown}>
                {navLinks.map((link) => (
                  <Link
                    ...
                    style={link.isDanger ? styles.logoutLink : styles.dropdownLink}
                  >
                    {link.label}
                  </Link>
                ))}
...
const styles = {
  header: { width: "100%", position: "relative", zIndex: 50 },
